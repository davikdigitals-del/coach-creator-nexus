    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold mt-4 text-foreground">Create your account</h1>
          <p className="text-muted-foreground mt-1">Start your learning journey</p>
        </div>

        <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
          <Button variant="outline" className="w-full mb-4 h-11" onClick={handleGoogleSignIn}>
